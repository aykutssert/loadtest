...
const STATUS_COLORS = {
  queued:    'text-[#a1a1aa] bg-[#1e293b]',
  running:   'text-[#f97316] bg-[#f9731615]',
        ...
        {tests.map((t) => (
          <li key={t.id}>
            <button
              ...
              className="w-full text-left bg-[#0a0a0f] hover:bg-[#0f0f18] border border-[#1e1e2e] hover:border-[#f9731630] rounded px-3 py-2.5 transition-colors"
            >
